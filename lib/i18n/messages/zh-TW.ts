...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.colorThemeNew": "新建主題",
    "settings.colorThemeEdit": "編輯",
    "settings.colorThemeDelete": "刪除",
    "settings.colorThemeSave": "儲存",
    "settings.colorThemeCancel": "取消",
    "settings.colorThemeName": "名稱",
    "settings.colorThemeDescription": "描述",
    "settings.colorThemeLightPalette": "淺色配色",
    "settings.colorThemeDarkPalette": "深色配色",
    "settings.colorThemeBuiltin": "內建",
    "settings.colorThemeSeed": "主題顏色",
    "settings.colorThemeBase": "基於模板",
    "settings.colorThemeGenerateDark": "從淺色生成深色",
    "settings.colorThemeInvalid": "請填寫名稱和全部顏色值（如 #rrggbb 或 rgba(...)）。",
    ...
    "system.label": "會話系統提示詞",
    "system.composition": "系統提示詞構成",
    "system.compositionHint": "按 pi 的估算口徑（字元數 ÷ 4）估算，非精確 token 數",
    "system.section.base": "基礎提示詞",
    "system.section.custom": "自訂提示詞",
    "system.section.tools": "工具清單",
    "system.section.guidelines": "指引與擴充注入",
    "system.section.context": "專案上下文",
    "system.section.skills": "技能",
    "system.section.cwd": "工作目錄",
    "system.section.other": "其他",
    "system.section.core": "pi 核心指引",
    "system.section.docs": "pi 文件附錄",
    "system.section.builtin": "pi 內建工具",
    "menu.agents": "代理列表",
    "menu.sessions": "會話清單",
    "menu.theme": "切換主題",
    "tools.label": "會話工具",
    ...
    "sidebar.activeElsewhere": "其他專案進行中",
    ...
    "sidebar.projectSessions": "{count} 個會話",
    "sidebar.expandProject": "展開專案",
    "sidebar.collapseProject": "摺疊專案",
    ...
    "files.save": "儲存",
    "files.saving": "儲存中…",
    "files.editHint": "正在編輯 {path}。Ctrl+S 儲存，Esc 取消。",
    "files.editFailed": "儲存失敗：{error}",
    ...
    "topbar.sessions": "會話",
    "topbar.noSessions": "暫無開啟的會話",
    "topbar.newTab": "新建會話",
    "topbar.closeTab": "關閉標籤",
    "topbar.pinnedTabs": "已開啟的會話",
    "topbar.runningUnpinned": "其他執行中的會話",
    ...
    "i18n.noChanges": "沒有更改",
    "i18n.branches": "會話分支",
    "i18n.branchesTooltip": "切換此會話內的對話分支（同一會話的不同對話路徑），不是 Git 分支",
    ...
    "models.peakPricing": "峰谷定價",
    "models.peakEnabled": "已啟用",
    "models.peakDisabled": "未啟用",
    "models.peakConfigure": "設定",
    "models.peakEnable": "啟用峰谷定價",
    "models.peakHours": "峰時段",
    ...
    "settings.usage": "用量統計",
    "usageStats.title": "用量統計",
    "usageStats.refresh": "重新整理",
    "usageStats.refreshing": "重新整理中…",
    "usageStats.loading": "正在統計…",
    "usageStats.error": "用量統計載入失敗，請稍後重試",
    "usageStats.errorHint": "錯誤訊息：{message}",
    "usageStats.empty.title": "暫無用量資料",
    "usageStats.empty.desc": "還沒有記錄到任何用量。Pi 會話需已安裝 pi-tracker 擴充並產生對話。",
    "usageStats.empty.backfill": "如需補上歷史用量，可在 pi 終端執行 /analytics import 回填。",
    "usageStats.notInstalled.desc": "Pi 會話的用量統計需要 pi-tracker 擴充在 pi 行程內記錄每次對話的 Token 消耗。安裝後請重啟 Agent 會話使擴充載入，並在會話中開始對話——只有產生對話後資料才會落盤。",
    "usageStats.notInstalled.restartHint": "安裝後需重啟 Agent 會話，擴充才會被 pi 載入",
    "usageStats.notInstalled.backfill": "外掛只記錄安裝之後的對話。如需補上歷史用量，可執行 /analytics import 回填。",
    "usageStats.window": "資料覆蓋 {since} 起，共 {days} 天",
    "usageStats.cards.totalTokens": "累計 Token",
    "usageStats.cards.totalCost": "累計成本",
    "usageStats.cards.turns": "呼叫次數",
    "usageStats.cards.activeDays": "活躍天數",
    "usageStats.cards.cacheHit": "快取命中率",
    "usageStats.cards.today": "今日",
    "usageStats.cards.week": "本週",
    "usageStats.balance.title": "供應商餘額",
    "usageStats.balance.col.provider": "供應商",
    "usageStats.balance.col.balance": "目前餘額（$）",
    "usageStats.balance.col.spent": "已扣",
    "usageStats.balance.col.remaining": "剩餘",
    ...
    "usageStats.balance.resetBalanceConfirm": "確定將 {provider} 的餘額重設為 0？此操作無法復原。",
    "usageStats.balance.resetSpentConfirm": "確定重置 {provider} 的已扣金額？已扣將從 0 重新累計，餘額不變。",
    ...
    "usageStats.cards.title": "累計概覽",
    "usageStats.heatmap.title": "活躍熱力圖",
    "usageStats.heatmap.tooltip": "{date}：{tokens} tokens · {turns} 次呼叫",
    "usageStats.daily.title": "每日用量",
    "usageStats.daily.rangeDay": "日",
    "usageStats.daily.rangeWeek": "週",
    "usageStats.daily.rangeMonth": "月",
    "usageStats.daily.tooltip": "{label}：{tokens} tokens",
    "usageStats.dayDetail.titleToday": "今日概覽",
    "usageStats.dayDetail.titleDay": "{date} 用量",
    "usageStats.dayDetail.backToday": "回今日",
    "usageStats.dayDetail.empty": "該天沒有用量記錄",
    "usageStats.dayDetail.providers": "Provider 分解",
    "usageStats.dayDetail.cards.tokens": "當日 Token",
    "usageStats.dayDetail.cards.cost": "當日成本",
    "usageStats.dayDetail.cards.turns": "當日呼叫次數",
    "usageStats.dayDetail.cards.sessions": "當日會話",
    "usageStats.dayDetail.cards.cacheHit": "當日快取命中率",
    "usageStats.dayDetail.cards.cacheSub": "讀 {read} · 寫 {write}",
    "usageStats.dayDetail.modelsTitle": "當日模型",
    "usageStats.dayDetail.projectsTitle": "當日項目",

    "usageStats.dayDetail.hoursTitle": "按小時分布",
    "usageStats.hour.noUsage": "無記錄",
    "usageStats.hour.hitPeak": "峰價",
    "usageStats.hour.hitOff": "谷價",
    "usageStats.hour.legendPeak": "峰價命中",
    "usageStats.hour.legendOff": "谷價命中",
    "usageStats.hour.legendPlain": "普通",
    "usageStats.hour.hitsTitle": "峰谷定價命中明細",
    "usageStats.hour.col.hour": "時段",
    "usageStats.hour.col.hit": "段位",
    "usageStats.hour.col.model": "模型",
    "usageStats.hour.col.tokens": "Token",
    "usageStats.hour.col.cost": "成本",
    "usageStats.models.title": "累計模型用量",
    "usageStats.models.col.model": "模型",
    "usageStats.models.col.tokens": "Token",
    "usageStats.models.col.cacheHit": "快取命中",
    "usageStats.models.col.output": "輸出",
    "usageStats.models.col.cost": "成本",
    "usageStats.models.col.turns": "呼叫次數",
