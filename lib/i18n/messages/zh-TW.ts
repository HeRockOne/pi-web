...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "usageStats.balance.col.balance": "初始充值金額（$）",
    "usageStats.balance.col.spent": "已扣",
    "usageStats.balance.col.remaining": "餘額",
    "usageStats.balance.col.actions": "操作",
    "usageStats.balance.placeholder": "未設定",
    "usageStats.balance.save": "儲存",
    "usageStats.balance.saved": "已儲存",
    "usageStats.balance.reset": "重置已扣",
    "usageStats.balance.invalid": "餘額必須為非負數",
