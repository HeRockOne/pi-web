...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "usageStats.balance.col.balance": "Initial Top-up ($)",
    "usageStats.balance.col.spent": "Spent",
    "usageStats.balance.col.remaining": "Balance",
    "usageStats.balance.col.actions": "Actions",
    "usageStats.balance.placeholder": "unset",
    "usageStats.balance.save": "Save",
    "usageStats.balance.saved": "Saved",
    "usageStats.balance.reset": "Reset spent",
    "usageStats.balance.invalid": "Balance must be a non-negative number",
