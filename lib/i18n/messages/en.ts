...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.colorThemeNew": "New theme",
    "settings.colorThemeEdit": "Edit",
    "settings.colorThemeDelete": "Delete",
    "settings.colorThemeSave": "Save",
    "settings.colorThemeCancel": "Cancel",
    "settings.colorThemeName": "Name",
    "settings.colorThemeDescription": "Description",
    "settings.colorThemeLightPalette": "Light palette",
    "settings.colorThemeDarkPalette": "Dark palette",
    "settings.colorThemeBuiltin": "Built-in",
    "settings.colorThemeSeed": "Theme color",
    "settings.colorThemeBase": "Base",
    "settings.colorThemeGenerateDark": "Generate dark from light",
    "settings.colorThemeInvalid": "Please fill in the name and every color value (e.g. #rrggbb or rgba(...)).",
    ...
    "system.label": "Session system prompt",
    "system.composition": "System prompt composition",
    "system.compositionHint": "Estimated with pi's heuristic (chars ÷ 4); not exact token counts",
    "system.section.base": "Base prompt",
    "system.section.custom": "Custom prompt",
    "system.section.tools": "Tools",
    "system.section.guidelines": "Guidelines & extensions",
    "system.section.context": "Project context",
    "system.section.skills": "Skills",
    "system.section.cwd": "Working directory",
    "system.section.other": "Other",
    "system.section.core": "pi core guidelines",
    "system.section.docs": "pi docs appendix",
    "system.section.builtin": "pi built-in tools",
    "menu.agents": "Subagents",
    "menu.sessions": "Sessions",
    "menu.theme": "Theme",
    "tools.label": "Session tools",
    ...
    "sidebar.activeElsewhere": "Active in other projects",
    ...
    "sidebar.projectSessions": "{count} sessions",
    ...
    "files.cancel": "Cancel",
    "files.saving": "Saving…",
    "files.editHint": "Editing {path}. Ctrl+S to save, Esc to cancel.",
    "files.editFailed": "Could not save file: {error}",
    ...
    "topbar.noSessions": "No open sessions",
    "topbar.newTab": "New session",
    "topbar.closeTab": "Close tab",
    "topbar.pinnedTabs": "Open tabs",
    "topbar.runningUnpinned": "Running in other sessions",
    ...
    "i18n.branches": "Session branches",
    "i18n.branchesTooltip": "Switch between conversation branches within this session (not Git branches)",
    ...
    "models.peakPricing": "Peak/off-peak pricing",
    "models.peakEnabled": "Enabled",
    "models.peakDisabled": "Disabled",
    "models.peakConfigure": "Configure",
    "models.peakEnable": "Enable peak/off-peak pricing",
    "models.peakHours": "Peak hours",
    ...
    "i18n.cost": "cost",
    "i18n.hitRate": "hit rate",
    "i18n.cacheRead": "cache read",
    "i18n.cacheWrite": "cache write",
    ...
    "usageStats.empty.desc": "No usage has been recorded yet. Pi sessions need the pi-tracker extension installed and at least one conversation.",
    "usageStats.empty.backfill": "Backfill historical usage with /analytics import in a pi terminal.",
    ...
    "usageStats.notInstalled.backfill": "The plugin only records conversations after installation. To backfill historical usage, run /analytics import.",
    ...
    "usageStats.cards.cacheHit": "Cache hit rate",
    "usageStats.cards.today": "Today",
    "usageStats.cards.week": "This week",
    "usageStats.balance.title": "Provider balances",
    "usageStats.balance.col.provider": "Provider",
    "usageStats.balance.col.balance": "Balance ($)",
    "usageStats.balance.col.spent": "Spent",
    "usageStats.balance.col.remaining": "Remaining",
    ...
    "usageStats.dayDetail.cards.cacheHit": "Cache hit today",
    "usageStats.dayDetail.cards.cacheSub": "read {read} · wrote {write}",
    "usageStats.dayDetail.modelsTitle": "Models today",
    "usageStats.dayDetail.projectsTitle": "Projects today",

    "usageStats.dayDetail.hoursTitle": "By hour",
    "usageStats.hour.noUsage": "No usage",
    "usageStats.hour.hitPeak": "Peak",
    "usageStats.hour.hitOff": "Off-peak",
    "usageStats.hour.legendPeak": "Peak hit",
    "usageStats.hour.legendOff": "Off-peak hit",
    "usageStats.hour.legendPlain": "Regular",
    "usageStats.hour.hitsTitle": "Peak-priced model hits",
    "usageStats.hour.col.hour": "Hour",
    "usageStats.hour.col.hit": "Pricing",
    "usageStats.hour.col.model": "Model",
    "usageStats.hour.col.tokens": "Tokens",
    "usageStats.hour.col.cost": "Cost",
