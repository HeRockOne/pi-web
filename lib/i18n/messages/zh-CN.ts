...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "usageStats.balance.col.balance": "初始充值金额（$）",
    "usageStats.balance.col.spent": "已扣",
    "usageStats.balance.col.remaining": "余额",
    "usageStats.balance.col.actions": "操作",
    "usageStats.balance.placeholder": "未设置",
    "usageStats.balance.save": "保存",
    "usageStats.balance.saved": "已保存",
    "usageStats.balance.reset": "重置已扣",
    "usageStats.balance.invalid": "余额必须是非负数",
