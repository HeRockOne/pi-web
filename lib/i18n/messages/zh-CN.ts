...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.colorThemeNew": "新建主题",
    "settings.colorThemeEdit": "编辑",
    "settings.colorThemeDelete": "删除",
    "settings.colorThemeSave": "保存",
    "settings.colorThemeCancel": "取消",
    "settings.colorThemeName": "名称",
    "settings.colorThemeDescription": "描述",
    "settings.colorThemeLightPalette": "浅色配色",
    "settings.colorThemeDarkPalette": "深色配色",
    "settings.colorThemeBuiltin": "内置",
    "settings.colorThemeSeed": "主题颜色",
    "settings.colorThemeBase": "基于模板",
    "settings.colorThemeGenerateDark": "从浅色生成深色",
    "settings.colorThemeInvalid": "请填写名称和全部颜色值（如 #rrggbb 或 rgba(...)）。",
    ...
    "system.label": "会话系统提示词",
    "system.composition": "系统提示词构成",
    "system.compositionHint": "按 pi 的估算口径（字符数 ÷ 4）估算，非精确 token 数",
    "system.section.base": "基础提示词",
    "system.section.custom": "自定义提示词",
    "system.section.tools": "工具列表",
    "system.section.guidelines": "指南与扩展注入",
    "system.section.context": "项目上下文",
    "system.section.skills": "技能",
    "system.section.cwd": "工作目录",
    "system.section.other": "其他",
    "system.section.core": "pi 核心指南",
    "system.section.docs": "pi 文档附录",
    "system.section.builtin": "pi 内置工具",
    "menu.agents": "代理列表",
    "menu.sessions": "会话列表",
    "menu.theme": "切换主题",
    "tools.label": "会话工具",
    ...
    "sidebar.activeElsewhere": "其他项目进行中",
    ...
    "sidebar.projectSessions": "{count} 个会话",
    ...
    "files.save": "保存",
    "files.saving": "保存中…",
    "files.editHint": "正在编辑 {path}。Ctrl+S 保存，Esc 取消。",
    "files.editFailed": "保存失败：{error}",
    ...
    "topbar.sessions": "会话",
    "topbar.noSessions": "暂无打开的会话",
    "topbar.newTab": "新建会话",
    "topbar.closeTab": "关闭标签",
    "topbar.pinnedTabs": "已打开的会话",
    "topbar.runningUnpinned": "其他运行中的会话",
    ...
    "i18n.noChanges": "没有更改",
    "i18n.branches": "会话分支",
    "i18n.branchesTooltip": "切换此会话内的对话分支（同一会话的不同对话路径），不是 Git 分支",
    ...
    "models.peakPricing": "峰谷定价",
    "models.peakEnabled": "已启用",
    "models.peakDisabled": "未启用",
    "models.peakConfigure": "配置",
    "models.peakEnable": "启用峰谷定价",
    "models.peakHours": "峰时段",
    "models.peakHourSuffix": "点（本地时间）",
    "models.peakAdd": "添加时段",
    "models.peakRates": "峰时价格（每百万 tokens）",
    "models.peakOffHours": "谷时段（其余时间自动）：",
    "models.peakHint": "未填写的峰时价格自动沿用上方基础价格（谷时价）。用量按每条请求所在的小时（本地时区）重新计价。",
    "models.peakInvalid": "请填写至少一个有效峰时段（0-23 点）和至少一项峰时价格。",
    "models.peakSave": "保存",
    ...
    "usageStats.empty.desc": "还没有记录到任何用量。Pi 会话需已安装 pi-tracker 扩展并产生对话。",
    "usageStats.empty.backfill": "如需补上历史用量，可在 pi 终端执行 /analytics import 回填。",
    "usageStats.notInstalled.desc": "Pi 会话的用量统计需要 pi-tracker 扩展在 pi 进程内记录每次对话的 Token 消耗。安装后请重启 Agent 会话使扩展加载，并在会话中开始对话——只有产生对话后数据才会落盘。",
    "usageStats.notInstalled.restartHint": "安装后需重启 Agent 会话，扩展才会被 pi 加载",
    "usageStats.notInstalled.backfill": "插件只记录安装之后的对话。如需补上历史用量，可执行 /analytics import 回填。",
    ...
    "usageStats.cards.cacheHit": "缓存命中率",
    "usageStats.cards.today": "今日",
    "usageStats.cards.week": "本周",
    "usageStats.balance.title": "供应商余额",
    "usageStats.balance.col.provider": "供应商",
    "usageStats.balance.col.balance": "当前余额（$）",
    "usageStats.balance.col.spent": "已扣",
    "usageStats.balance.col.remaining": "剩余",
    ...
    "usageStats.balance.resetSpentConfirm": "确定重置 {provider} 的已扣金额？已扣将从 0 重新累计，余额不变。",


    "usageStats.balance.saved": "已保存",
    "usageStats.balance.reset": "重置已扣",
    "usageStats.balance.invalid": "充值金额必须是非负数",
    "usageStats.balance.empty": "暂无供应商，用量记录出现后会显示在此处。",
    ...
    "usageStats.dayDetail.cards.cacheHit": "当日缓存命中率",
    "usageStats.dayDetail.cards.cacheSub": "读 {read} · 写 {write}",
    "usageStats.dayDetail.modelsTitle": "当日模型",
    "usageStats.dayDetail.projectsTitle": "当日项目",

    "usageStats.dayDetail.hoursTitle": "按小时分布",
    "usageStats.hour.noUsage": "无记录",
    "usageStats.hour.hitPeak": "峰价",
    "usageStats.hour.hitOff": "谷价",
    "usageStats.hour.legendPeak": "峰价命中",
    "usageStats.hour.legendOff": "谷价命中",
    "usageStats.hour.legendPlain": "普通",
    "usageStats.hour.hitsTitle": "峰谷定价命中明细",
    "usageStats.hour.col.hour": "时段",
